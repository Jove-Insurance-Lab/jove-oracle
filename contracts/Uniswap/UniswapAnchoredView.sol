...
contract UniswapAnchoredView is UniswapConfig {
    ...
    /**
     * @notice Get the underlying price of a jToken
     * @param jToken The jToken address for price retrieval
     * @return Price denominated in USD, with 18 decimals, for the given jToken address
     */
    function getUnderlyingPrice(address jToken) external view returns (uint) {
        TokenConfig memory config = getTokenConfigByJToken(jToken);
